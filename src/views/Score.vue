...
const localResult = (JSON.parse(localStorage.getItem(LocalStorageKey.SCORE)!!) || Array.from({ length: 6 }).map((_, it) => ({label: `${it + 1}/6`, value: 0}))) as {label: string, value: number}[];
